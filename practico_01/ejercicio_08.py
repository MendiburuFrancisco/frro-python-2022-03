...
def superposicion_basico(lista_1: Iterable[Any], lista_2: Iterable[Any]) -> bool:
    ...
    """
    bandera = False
    for elementFromFirstList in lista_1:
            if bandera == True:
                break
            for elementFromSecondList in lista_2:
                 if elementFromFirstList == elementFromSecondList:
                    bandera = True
                    break
...
def superposicion_in(lista_1: Iterable[Any], lista_2: Iterable[Any]) -> bool:
    ...
    bandera = False
    for elementFromFirstList in lista_1:
        if elementFromFirstList in lista_2:
            bandera = True
            break
    return bandera
...
def superposicion_any(lista_1: Iterable[Any], lista_2: Iterable[Any]) -> bool:
    ...
    """
    return any(filter(lambda l: l in lista_2,lista_1))
